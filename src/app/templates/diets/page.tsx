...
import { supabase, type DietTemplate } from '@/lib/supabase'
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-bold text-gray-800">Templates de Dieta</h1>
      ...
      {templates.length === 0 ? (
        <div className="bg-white p-8 rounded-lg shadow-md text-center">
          <p className="text-gray-500 text-lg">Nenhum template de dieta encontrado</p>
          <Link
            href="/templates/diets/new"
